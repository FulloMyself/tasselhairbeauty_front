...
const Home = () => {
  ...
  // Team members data
  const teamMembers = [
    { id: 1, name: "Sandra", role: "Staff - Nails Department", specialization: "Nail Tech", image: `${assetsPath}images/team/sandra.jpeg`, bio: "Sandra is a skilled nail technician with a passion for creating beautiful and unique nail designs.", quote: "Beautiful nails are the perfect finishing touch to any look.", instagram: "https://www.instagram.com/tasselhairandbeautystudio_/", whatsapp: "https://wa.me/27729605153" },
    { id: 2, name: "Nomonde", role: "Staff - Beauty and Skincare Department", specialization: "Beauty Therapist", image: `${assetsPath}images/team/nomonde.jpeg`, bio: "Nomonde brings precision and artistry to every treatment.", quote: "Healthy skin is beautiful skin.", instagram: "https://www.instagram.com/tasselhairandbeautystudio_/", whatsapp: "https://wa.me/27729605153" },
    { id: 3, name: "Natasha", role: "Staff - Hair and Kiddies Department", specialization: "Kiddies Hair Stylist", image: `${assetsPath}images/team/natasha.jpeg`, bio: "Natasha's creative styling and gentle approach have made her a favorite among young clients.", quote: "Every child deserves to feel special.", instagram: "https://www.instagram.com/tasselhairandbeautystudio_/", whatsapp: "https://wa.me/27729605153" },
    { id: 4, name: "Cynthia", role: "Staff - Hair and Kiddies Department", specialization: "Kiddies Hair Stylist", image: `${assetsPath}images/team/cynthia.jpeg`, bio: "Cynthia specializes in creating magical hairstyles for children.", quote: "Beautiful hair expresses personality.", instagram: "https://www.instagram.com/tasselhairandbeautystudio_/", whatsapp: "https://wa.me/27729605153" },
    { id: 5, name: "Tiny", role: "Staff - Hair and Kiddies Department", specialization: "Kiddies Hair Stylist", image: `${assetsPath}images/team/tiny.jpeg`, bio: "Tiny's gentle approach makes kids feel comfortable.", quote: "Every child's hair is unique.", instagram: "https://www.instagram.com/tasselhairandbeautystudio_/", whatsapp: "https://wa.me/27729605153" },
    { id: 6, name: "Thando", role: "Staff - Hair and Kiddies Department", specialization: "Kiddies Hair Stylist", image: `${assetsPath}images/team/thando.jpeg`, bio: "Thando loves creating fun styles for kids.", quote: "Happy kids, happy parents.", instagram: "https://www.instagram.com/tasselhairandbeautystudio_/", whatsapp: "https://wa.me/27729605153" },
    { id: 7, name: "Keisha", role: "Staff - Receptionist and Hair Department", specialization: "Hair Stylist, Receptionist", image: `${assetsPath}images/team/keisha.jpeg`, bio: "The friendly face behind your bookings.", quote: "Your smile is our greatest reward.", instagram: "https://www.instagram.com/tasselhairandbeautystudio_/", whatsapp: "https://wa.me/27729605153" },
    { id: 8, name: "Cheslyn", role: "Staff - Hair Department", specialization: "Barber", image: `${assetsPath}images/team/cheslyn.jpeg`, bio: "Cheslyn specializes in precision cuts for men and children.", quote: "A great haircut changes everything.", instagram: "https://www.instagram.com/tasselhairandbeautystudio_/", whatsapp: "https://wa.me/27729605153" }
  ];

  // Gallery items
  const galleryItems = [
    { type: 'photo', category: 'kids', src: `${assetsPath}images/compressed_CuteBabyBraids.jpeg`, caption: 'Kiddies Braiding' },
    { type: 'photo', category: 'studio', src: `${assetsPath}images/compressed_KiddiesStation.jpeg`, caption: 'Kiddies Station' },
    { type: 'video', category: 'barber', src: `${assetsPath}videos/MensCutAndWash.mp4`, poster: `${assetsPath}images/MensHairCut.png`, caption: 'Men\'s Haircut Session' },
    { type: 'photo', category: 'hair', src: `${assetsPath}images/compressed_AdultHair.jpeg`, caption: 'Professional Styling' },
    { type: 'photo', category: 'kids', src: `${assetsPath}images/KiddiesHairstyleSession.jpeg`, caption: 'Kiddies Hairstyle Session' },
    { type: 'video', category: 'welcome', src: `${assetsPath}videos/Welcome.mp4`, poster: `${assetsPath}images/compressed_Receptionist.jpeg`, caption: 'Welcome To Tassel' },
    { type: 'photo', category: 'kids', src: `${assetsPath}images/CuteBabyTasselLogo.jpeg`, caption: 'Happy Kids, Beautiful Experiences' },
    { type: 'video', category: 'nails', src: `${assetsPath}videos/Tassel.mp4`, poster: `${assetsPath}images/compressed_TasselNailBar.jpeg`, caption: 'Book With Us' },
    { type: 'photo', category: 'studio', src: `${assetsPath}images/compressed_Seat.jpeg`, caption: 'Relaxation Lounge' },
    { type: 'video', category: 'barber', src: `${assetsPath}videos/BarbarSection.mp4`, poster: `${assetsPath}images/MensHairstyle.png`, caption: 'Barber Section' },
    { type: 'video', category: 'welcome', src: `${assetsPath}videos/Books.mp4`, poster: `${assetsPath}images/KiddiesCorner.jpeg`, caption: 'Kiddies Corner' }
  ];
  ...
  useEffect(() => {
    const interval = setInterval(() => setCurrentSpecialSlide((prev) => (prev + 1) % 6), 5000);
    return () => clearInterval(interval);
  }, []);
  ...
  const nextSpecialSlide = () => setCurrentSpecialSlide((prev) => (prev + 1) % 6);
  const prevSpecialSlide = () => setCurrentSpecialSlide((prev) => (prev - 1 + 6) % 6);
        ...
        <section id="hero" className="hero-carousel">
          <div className="carousel-container">
            <div className={`carousel-slide ${currentSlide === 0 ? 'active' : ''}`}>
              <img src={`${assetsPath}images/compressed_TasselNailBar.jpeg`} alt="Luxury nail bar" className="carousel-image" />
            ...
            <div className={`carousel-slide ${currentSlide === 1 ? 'active' : ''}`}>
              <img src={`${assetsPath}images/compressed_FullTeam.jpeg`} alt="Tassel Team" className="carousel-image" />
              <div className="carousel-overlay"></div>
              <div className="carousel-content">
            ...
            <div className={`carousel-slide ${currentSlide === 2 ? 'active' : ''}`}>
              <img src={`${assetsPath}images/compressed_KiddiesStation.jpeg`} alt="Kiddies Station" className="carousel-image" />
              <div className="carousel-overlay"></div>
              <div className="carousel-content">
        ...
        <section id="why" className="section-wrap">
          <div className="container">
            ...
            <div className="pillars">
              <div className="pillar fade"><img src={`${assetsPath}images/KiddiesHairstyleSession.jpeg`} alt="Child's hair styled" className="pillar-img" /><h3 className="pillar-title">Kiddies Hair Specialists</h3><p className="pillar-desc">Gentle, professional styling designed for children — in a warm, welcoming space.</p></div>
              <div className="pillar fade"><img src={`${assetsPath}images/MensHairCut.png`} alt="Professional barber services" className="pillar-img" /><h3 className="pillar-title">Premium Barber Services</h3><p className="pillar-desc">Sharp fades, beard trims & modern cuts for boys and men. Walk-ins welcome.</p></div>
              <div className="pillar fade"><img src={`${assetsPath}images/compressed_ProductVariety.jpeg`} alt="Products from Tassel" className="pillar-img" /><h3 className="pillar-title">One‑Stop Convenience</h3><p className="pillar-desc">Hair, barber & beauty services for the whole family — no more running around.</p></div>
              <div className="pillar fade"><img src={`${assetsPath}images/compressed_Seat.jpeg`} alt="Luxury salon interior" className="pillar-img" /><h3 className="pillar-title">Luxury Experience</h3><p className="pillar-desc">A calm, clean, professional environment curated for a premium feel.</p></div>
            </div>
          </div>
        </section>
        ...
        <section id="services" className="section-wrap" style={{ background: 'var(--soft)' }}>
          <div className="container">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '20px', marginBottom: '40px' }}>
              ...
              <a href={`${assetsPath}pricelists/Tassel_Full_Services_PriceList.pdf`} className="btn-primary" target="_blank" rel="noopener noreferrer" download><i className="fas fa-file-pdf"></i> View All Prices</a>
            </div>
            <div className="services-grid">
              <a href={`${assetsPath}pricelists/Tassel_Kiddies_Hair_PriceList.pdf`} className="service-card fade" target="_blank" rel="noopener noreferrer" download><img src={`${assetsPath}images/compressed_KiddiesCuteHairstyle.jpeg`} alt="Child getting hair done" className="service-img" /><h3 className="service-name">Kiddies Hair</h3><span className="service-link">Download Price List <i className="fas fa-download"></i></span></a>
              <a href={`${assetsPath}pricelists/Tassel_Barber_Price_List.pdf`} className="service-card fade" target="_blank" rel="noopener noreferrer" download><img src={`${assetsPath}images/BarbarSection.jpeg`} alt="Barber services" className="service-img" /><h3 className="service-name">Barber</h3><span className="service-link">Download Price List <i className="fas fa-download"></i></span></a>
        ...
        <section id="about" className="section-wrap">
          <div className="container">
            <div className="about-grid">
              <div className="about-img fade"><img src={`${assetsPath}images/compressed_FullTeam.jpeg`} alt="Tassel Team" loading="lazy" /><p className="img-caption">calm · professional · family</p></div>
              <div>
        ...
        <section id="brands" className="section-wrap brands-section">
          <div className="container">
            ...
            <div className="brands-grid">
              <div className="brand-card fade"><div className="brand-logo-wrapper"><img src={`${assetsPath}brands/Tassel.svg`} alt="Tassel" className="brand-logo" /></div><h3>Tassel Studio</h3><p>Our signature brand — excellence in every service</p></div>
              <div className="brand-card fade"><div className="brand-logo-wrapper"><img src={`${assetsPath}brands/Esse.svg`} alt="Esse Skincare" className="brand-logo" /></div><h3>Esse Skincare</h3><p>Probiotic skincare for healthy, radiant skin</p></div>
              <div className="brand-card fade"><div className="brand-logo-wrapper"><img src={`${assetsPath}brands/ResaK.svg`} alt="Resa-K" className="brand-logo" /></div><h3>Resa-K</h3><p>Advanced keratin & hair restoration treatments</p></div>
              <div className="brand-card fade"><div className="brand-logo-wrapper"><img src={`${assetsPath}brands/Popsicle.svg`} alt="Popsicle Nails" className="brand-logo" /></div><h3>Popsicle Professional Nails</h3><p>Premium nail care & cuticle nourishment</p></div>
            </div>
